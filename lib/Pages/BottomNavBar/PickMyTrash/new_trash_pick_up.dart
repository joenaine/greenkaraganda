...
class _NewTrashPickUpState extends State<NewTrashPickUp> {
  ...
  Map<String, bool> trashTypeValues = {
    'Пластик и полиэтилен': false,
    'Стекло': false,
    'Бумага': false,
    'Металл': false,
    'Клинические отходы': false,
    'Электронные отходы': false,
  };
  ...
  String userCurrentAddress = "Местоположение не выбрано";
  String selectedFromMapAddress = "Местоположение не выбрано";
  String trashLocationAddress = "Местоположение не выбрано";
          ...
          builder: (context, setState) {
            return AlertDialog(
              title: !isUploadComplete
                  ? Center(child: Text("Отправляем"))
                  : Center(child: Text("Успешно опубликовано")),
              content: Column(
                    ...
                    !isAnError
                        ? Column(
                            ...
                            children: [
                              ...
                              Text("Подождите, пока ваш пост загрузится.",
  ...
  void validatePickUp() {
    ...
    } else if (trashLocationAddress == "Местоположение не выбрано") {
  ...
  Widget build(BuildContext context) {
    void navigateAndDisplaySelection(BuildContext context) async {
      ...
      setState(() {
        if (result == null) {
          selectedFromMapAddress = "Местоположение не выбрано";
        } else {
    ...
    showInfoAlert(BuildContext context) {
      String infoTitle = "Руководство по выбору места";
      String infoMessage =
          "Чтобы выбрать место, просто нажмите на карту, и выбранное место будет отмечено этим маркером..";
      showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
          ...
          children: trashTypeValues.keys.map((String key) {
            ...
            switch (key) {
              case "Пластик и полиэтилен":
                ...
                description = "Пластик и полиэтилен";
                break;
              case "Стекло":
                color = Colors.red;
                description = "Стекло";
              ...
              case "Клинические отходы":
                color = Colors.yellow;
                description = "Клинические отходы";
                break;
              case "Электронные отходы":
                color = Colors.grey.shade200;
                description = "Электронные отходы";
                break;
              default:
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: "Описание сырья",
                    labelText: 'Описание сырья',
                    focusedBorder: UnderlineInputBorder(
                      borderSide: const BorderSide(color: Colors.black),
                    ),
                    labelStyle: TextStyle(
                ...
                Container(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        dateSelectCard("Начало", _startDate, startDate),
                        dateSelectCard("Конец", _returnDate, returnDate),
                      ],
                    ),
                  ),
                ),
                ...
                Container(
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        timeSelectCard(
                            "Начиная с", _startTime, _timeS.format(context)),
                        timeSelectCard(
                            "До", _returnTime, _timeR.format(context)),
                      ],
                    ),
                  ),
                ),
