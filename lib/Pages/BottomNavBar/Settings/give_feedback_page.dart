          ...
          builder: (context, setState) {
            return AlertDialog(
              title: !isUploadComplete
                  ...
                  : Center(child: Text("Успешно отправлено")),
              content: Column(
                    ...
                    !isAnError
                        ? Column(
                            ...
                            children: [
                              ...
                              Text(
                                  "Пожалуйста, подождите, пока ваш отзыв не будет отправлен.",
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 30),
                            Text("Обратная связь успешно отправлена!",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                        fontFamily: 'Montserrat',
                                        fontSize: 22.0)
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                helperText: "Число букв: $charLength",
                hintText: "Скажи что-нибудь о своей идее",
                labelText: 'Напишити ваш комментарий',
