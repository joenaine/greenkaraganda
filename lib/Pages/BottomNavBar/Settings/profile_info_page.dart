...
class _ProfileInfoPageState extends State<ProfileInfoPage> {
          ...
          builder: (context, setState) {
            return AlertDialog(
              title: !isUploadComplete
                  ? Center(child: Text("Обновление профиля"))
                  : Center(child: Text("Профиль обновлен")),
              content: Column(
                    ...
                    !isAnError
                        ? Column(
                            ...
                            children: [
                              ...
                              Text("Подождите, пока ваш профиль не обновится.",
  ...
  void validateEdits() {
    if (_userSelectedFileImage == null) {
      ToastMessages().toastError("Пожалуйста выберите фото", context);
    } else {
      showAlertDialog(context);
